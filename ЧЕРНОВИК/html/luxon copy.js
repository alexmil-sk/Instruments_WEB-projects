...
//!__ТАЙМЕР__1___________________________________________
...
const TimerX = setInterval(function () {
	...
	const beginTimer = document.querySelector('#startTimer');
...
//!__TIMER__2__________________________________________________________________
...
const f = startTimer2.addEventListener('click', (e) => {
	e.preventDefault();
	userTime = +prompt('Введите время таймера в минутах') * 60;
